        ...
        table.render({
            ...
            , cols: [[
                ...
                , {
                    field: 'createTime',
                    title: '创建时间',
                    templet: "<div>{{d.createTime?layui.util.toDateString(d.createTime, 'yyyy-MM-dd HH:mm:ss'):'未知'}}</div>"
                }
                , {
                    field: 'updateTime',
                    title: '更新创建',
                    templet: "<div>{{d.createTime?layui.util.toDateString(d.createTime, 'yyyy-MM-dd'):'未知'}}</div>"
                }
